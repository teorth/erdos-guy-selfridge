...
Using \Cref{bound23}, we can leave a large surplus at primes $2,3$ and still get good bounds:
...
Applying \Cref{bound23}, we can find a subfactorization $\vec b'$ of $2^n 3^m$ with an excess of at most $(\kappa_L \log \sqrt{12}) \frac{N}{\log t}$, and with
...
We conclude that $\vec b'$ obeys the hypotheses of \Cref{new-balance-3}, and the claim follows.
\end{proof}
